...
func newTestEngine() http.Handler {
	...
	engine := New(cfg, logger, healthHandler, authHandler, userHandler, libraryHandler, nodeHandler, directoryHandler, fileHandler, tagHandler, browserBookmarkHandler, browserFileMappingHandler, uploadHandler, httpHandler.NewStorageConfigHandler(nil, ""), httpHandler.NewMigrationHandler(nil), httpHandler.NewResourceMonitorHandler(nil))
	return engine
}
...
func TestHealthRoutes(t *testing.T) {
	...
	engine := New(cfg, logger, healthHandler, authHandler, userHandler, libraryHandler, nodeHandler, directoryHandler, fileHandler, tagHandler, browserBookmarkHandler, browserFileMappingHandler, httpHandler.NewUploadHandler(nil), httpHandler.NewStorageConfigHandler(nil, ""), httpHandler.NewMigrationHandler(nil), httpHandler.NewResourceMonitorHandler(nil))
...
func newBookmarkBehaviorTestEngine(bookmarkRepo *routerTestBrowserBookmarkRepository) http.Handler {
	...
	return New(cfg, logger, healthHandler, authHandler, userHandler, libraryHandler, nodeHandler, directoryHandler, fileHandler, tagHandler, browserBookmarkHandler, browserFileMappingHandler, httpHandler.NewUploadHandler(nil), httpHandler.NewStorageConfigHandler(nil, ""), httpHandler.NewMigrationHandler(nil), httpHandler.NewResourceMonitorHandler(nil))
}
