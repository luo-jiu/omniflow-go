...
func newTag(db *gorm.DB, opts ...gen.DOOption) tag {
	...
	_tag.TargetKey = field.NewString(tableName, "target_key")
	_tag.OwnerUserID = field.NewInt64(tableName, "owner_user_id")
	_tag.Color = field.NewString(tableName, "color")
	_tag.TextColor = field.NewString(tableName, "text_color")
	_tag.SortOrder = field.NewInt32(tableName, "sort_order")
	_tag.Enabled = field.NewBool(tableName, "enabled")
	...
	_tag.Scope = field.NewString(tableName, "scope")
	_tag.Dimension = field.NewString(tableName, "dimension")
	_tag.ResourceKind = field.NewString(tableName, "resource_kind")
...
func (t *tag) updateTableName(table string) *tag {
	...
	t.TargetKey = field.NewString(table, "target_key")
	t.OwnerUserID = field.NewInt64(table, "owner_user_id")
	t.Color = field.NewString(table, "color")
	t.TextColor = field.NewString(table, "text_color")
	...
	t.Dimension = field.NewString(table, "dimension")
...
func (t *tag) fillFieldMap() {
	...
	t.fieldMap["target_key"] = t.TargetKey
	t.fieldMap["owner_user_id"] = t.OwnerUserID
	t.fieldMap["color"] = t.Color
	t.fieldMap["text_color"] = t.TextColor
	...
	t.fieldMap["dimension"] = t.Dimension
